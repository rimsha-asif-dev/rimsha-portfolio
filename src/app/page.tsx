        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gray-900 rounded-2xl p-6 hover:shadow-md border border-blue-500 shadow-blue-900/50 transition-shadow duration-300 group">
                <div className="w-16 h-16 bg-blue-900/30 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:bg-blue-900/50 transition-colors">
                  {project.icon}
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 bg-black rounded-full text-sm text-white border border-blue-500"
                    >
                      {tech}
                    </span>
                  ))}
