    ...
    <div className=" flex flex-col md:flex-row min-h-screen bg-white items-center justify-center px-4 md:px-8 lg:px-20 py-8 gap-6">
      ...
      <div className="flex-1 flex flex-col justify-end items-center text-[#212033] w-[70%]">
        ...
        <p className="mb-8 text-lg md:text-xl text-gray-700 max-w-2xl">
          If you're looking for a passionate and skilled software engineer to
          drive your next project or join your team. Let's build something great
          together! Whether you're launching a new project, scaling your team,
          or looking for a fresh perspective — I’m ready to bring technical
          excellence and creativity to the table Reach out and let’s connect!.
        </p>
        <div
